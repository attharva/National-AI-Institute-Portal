...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const fetchAllEventsData = () => {
        const fetchUrl = `/admin/getPublicationsData`;
    ...
    function editFunction(id) {
        ...
        document.getElementById("publicationAuthors").value = publicationToEdit.all_authors;
    ...
    document.getElementById("saveEditModal").addEventListener("click", () => {
        ...
        const hideUrl = `/admin/editPublicationsData`
        fetch(hideUrl, {
            method: 'POST',
            headers: {
    ...
    document.getElementById("deleteDeleteModal").addEventListener("click", () => {
        ...
        const hideUrl = `/admin/hidePublicationsData`
        fetch(hideUrl, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
    ...
    document.getElementById("runScript").addEventListener("click", () => {
        ...
        const publicationScriptsUrl = `/admin/runPublicationsScripts`
        fetch(publicationScriptsUrl, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
