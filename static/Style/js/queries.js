document.addEventListener("DOMContentLoaded", function() {
    ...
    .then(data => {
        ...
        if (data.hasOwnProperty("queries") && Array.isArray(data.queries)) {
            data.queries.forEach((item, index) => {
                ...
                secondAnchor.title = "Mark Resolve";
                        ...
                        if (result.isConfirmed) {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    Swal.fire(
                                        'Resolved!',
                                        'The query has been marked as resolved.',
                                        'success'
                                    );
                                } else {
                                    Swal.fire({
