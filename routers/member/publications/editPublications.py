...
memberEditPublicationsData = APIRouter()
...
@memberEditPublicationsData.post("/member/editPublicationsData")
async def editPublicationsData(publicationObj: PublicationClass, request: Request):
    ...
    try:
        ...
        try:
            ...
            query = f"Update publications set name = '{publicationName}', authors = '{publicationAuthors}', venue = '{publicationVenue}', year = '{publicationYear}', modifiedBy = '{memberID}' WHERE publicationId = {publicationId};"
