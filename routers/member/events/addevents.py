...
memberEventsData = APIRouter()


@memberEventsData.post("/member/addEventsData")
...
@memberEventsData.post("/member/updateEventsData")
...
@memberEventsData.post("/member/updateEventsImgData")
async def update_EventsImgData(
    ...
    try:
        ...
        # Define the SQL query with placeholders
            ...
            # Create a list of data to be inserted, including memberId and image_data
        ...
        if images is not None: 
            for image in images:
                ...
                # Create a dictionary with the data to be inserted, including memberID and image_data
                img_data_to_insert = {
                    "identifier": id,
                    "type": "event",
